...
It reports a PASS if the TMR1 has generated at least one interrupt (Checked using polling method) and the total number of interrupts generated
...
> **Note** This startup self-test utilizes the interrupts generated by TMR1 (Polling method) and TMR2. For run-time testing of interrupts,
