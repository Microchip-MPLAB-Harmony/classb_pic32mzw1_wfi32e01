...
This function is called from the '_on_bootstrap' function which is the first function to be executed after a reset.
...
time period. It reports a PASS if the TMR1 has generated at least one interrupt (Check usinf polling method) and the total number of interrupts
